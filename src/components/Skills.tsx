...
const Skills = () => {
  return (
    <div className="flex flex-wrap justify-center gap-2 lg:gap-7">
      ...
      <Skill width={["35px", "40px"]} src="/tailwind.png" name="Tailwind" />
      <Skill width={["60px", "70px"]} src="/chakra.png" name="ChakraUI" />
      <Skill width={["32px", "40px"]} src="/shadcn.png" name="ShadcnUI" />
      <Skill width={["32px", "40px"]} src="/javascript.png" name="Javascript" />
      <Skill width={["32px", "40px"]} src="/typescript.png" name="Typescript" />
      ...
      <Skill width={["32px", "40px"]} src="/express.png" name="ExpressJS" />
      <Skill width={["32px", "40px"]} src="/mongo.png" name="MongoDB" />
      <Skill width={["32px", "40px"]} src="/prisma.png" name="Prisma" />
      <Skill width={["40px", "50px"]} src="/firebase.png" name="Firebase" />
      ...
      <Skill width={["40px", "50px"]} src="/chatgpt.png" name="AI" />
    </div>
  );
};
